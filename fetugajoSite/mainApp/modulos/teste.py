...
##teste(compraJogo("Monopoly", "data/tabela_de_valores.json", "data/"),0)
##teste(compraJogo(!, "data/tabela_de_valores.json", "data/"),1)
teste(adicionaPreferencia("Monopoly", "data/"),0)
teste(adicionaPreferencia(5, "data/"),1)
teste(recebePrecoCompra("Monopoly", "data/"),0)
teste(recebePrecoCompra(1, "data/"),1)
teste(recebePrecoCompra("Quest", "data/"),2)